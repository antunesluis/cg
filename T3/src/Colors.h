...
public:
  ...
  static void roadCenterLine() {
    CV::color(0.95f, 0.95f, 0.40f);
  } // Linha central amarela
  static void roadEdgeLine() {
    CV::color(0.95f, 0.95f, 0.95f);
  ...
  static void backgroundDefault() {
    CV::clear(0.18f, 0.20f, 0.25f);
  } // Azul escuro
  static void backgroundNight() {
    CV::clear(0.08f, 0.10f, 0.18f);
  } // Azul noturno
  static void backgroundDesert() { CV::clear(0.72f, 0.62f, 0.48f); } // Areia
  static void backgroundSpace() {
    CV::clear(0.05f, 0.06f, 0.12f);
  } // Espaço profundo

  static void controlPointAnchor() { CV::color(1.0f, 0.5f, 0.0f); } // Laranja
  static void controlPointHandle() {
    CV::color(0.0f, 0.8f, 1.0f);
  } // Azul claro
