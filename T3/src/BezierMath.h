...
static Vector2 calculatePoint(float t, const Vector2 &p0, const Vector2 &p1, const Vector2 &p2, const Vector2 &p3)
{
    float u = 1.0f - t;
    float tt = t * t;
    float uu = u * u;
...
static Vector2 calculateTangent(float t, const Vector2 &p0, const Vector2 &p1, const Vector2 &p2, const Vector2 &p3)
{
    float u = 1.0f - t;
    float uu = u * u;
    float tt = t * t;
